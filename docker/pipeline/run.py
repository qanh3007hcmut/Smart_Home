...
humidifiers: List[HumidifierConfig] = [factory['humidifier'].create(humidifier_conf) for humidifier_conf in config["humidifier"]] 

ini_entities = [binary_sensors, locks, lights, hvacs, switches, humidifiers]
def run():
    mqtt.connect()
